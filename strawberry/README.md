...
<param ve-iframe
               src="https://archive.org/details/comentarios-reales-de-los-incas/page/420/mode/2up">

Frézier’s feat has been retold many times with overtones that border on fiction and obscure the prior knowledge of the fruit by Indigenous peoples. Fascinated by its larger size compared to the smaller European variety, Frézier successfully transported five plants of this South American strawberry on a six-month sea voyage, an act which led to a prolonged process of experimentation[^21]. In his travel memoirs, *A Voyage to the South-Sea, and along the Coasts of Chili and Peru, in the years 1712, 1713, and 1714*, like the Spaniards, Frézier would also compare it in size to walnuts or hens’ eggs [^22]. The only discrepancy between his account and his predecessors’ was that the fruit of the New World was "somewhat less delicious in taste than our wood strawberries"[^23]. While some knowledge and uses of Fragaria chiloensis plants among indigenous populations can be found in scattered and isolated instances, the information has become disconnected from its context or heavily mediated. This reality has provoked a legacy of transplantation in which we can mainly access Indigenous ways of knowing through metropolitan sources.
<param ve-iframe
